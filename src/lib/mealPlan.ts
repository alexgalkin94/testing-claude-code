...
// Quick presets für schnelles Logging
export const QUICK_PRESETS = {
  dayA: [
    { name: 'Frühstück komplett (Tag A)', calories: 630, protein: 40 },
    { name: 'Iglo Schlemmer + Kartoffeln', calories: 470, protein: 45 },
    { name: 'Hähnchen + Gemüsepfanne', calories: 475, protein: 50 },
    { name: 'Skyr Snack', calories: 125, protein: 22 },
  ],
  dayB: [
    { name: 'Frühstück komplett (Tag B)', calories: 630, protein: 40 },
    { name: 'Hähnchen + Reis + Gemüse', calories: 590, protein: 55 },
    { name: 'Rinderhack + Gemüse', calories: 390, protein: 45 },
    { name: 'Quark Snack', calories: 95, protein: 16 },
  ],
};
